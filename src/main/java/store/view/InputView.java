...
public class InputView {
    ...
    public static String confirmApplyPromotion() {
        System.out.println("멤버십 할인을 받으시겠습니까? (Y/N)");
        return Console.readLine();
    }

    public static String confirmAddFreeProduct(Product product) {
        System.out.println("현재 " + product.getName() + "은(는) 1개를 무료로 더 받을 수 있습니다. 추가하시겠습니까? (Y/N)");
        return Console.readLine();
    }

    public static String confirmPromotionConfirm(Product product, int changeStock) {
        System.out.println(
